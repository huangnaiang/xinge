...
function XingeApp(accessId, secretKey){
	...
	/**
	 * [pushByTags description]
	 * @param  {[type]}   deviceType   [description]
	 * @param  {[type]}   tags         [description]
	 * @param  {[type]}   tagOperation [description]
	...
	/**
	 * [queryPushStatus description]
	 * @param  {[type]}   pushIds   [description]
	 * @param  {[type]}   validTime [description]
	 * @param  {Function} callback  [description]
	 * @return {[type]}             [description]
	 */
