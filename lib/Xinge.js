...
function XingeApp(accessId, secretKey){
	...
	this.pushToSingleDevice = function(deviceToken, message, environment, callback){
		...
		//调用API
		callAPI(API_PUSH_TO_SINGLE_DEVICE, params, "POST", 3000, this.secretKey, callback);
	};
	...
	this.pushToSingleAccount = function(deviceType, account, message, environment, callback){
		...
		//调用API
		callAPI(API_PUSH_TO_SINGLE_ACCOUNT, params, "POST", 3000, this.secretKey, callback);
	...
	this.pushToAllDevices = function(deviceType, message, environment, callback){
		...
		//调用API
		callAPI(API_PUSH_TO_ALL_DEVICES, params, "POST", 3000, this.secretKey, callback);
	...
	this.pushByTags = function(deviceType, tags, tagOperation, message, environment, callback){
		...
		//调用API
		callAPI(API_PUSH_BY_TAGS, params, "POST", 3000, this.secretKey, callback);
	...
	this.queryPushStatus = function(pushIds, callback){
		...
		//调用API
		callAPI(API_QUERY_PUSH_STATUS, params, "POST", 3000, this.secretKey, callback);
	 ...
	 * @param  {Function} callback(err, result) 回调函数
	 */
	this.queryDeviceCount = function(callback){
		...
		//调用API
		callAPI(API_QUERY_DEVICE_COUNT, params, "POST", 3000, this.secretKey, callback);
	...
	this.queryTags = function(start, limit, callback){
		...
		//调用API
		callAPI(API_QUERY_TAGS, params, "POST", 3000, this.secretKey, callback);
	...
	this.cancelTimingTask = function(pushId, callback){
		...
		//调用API
		callAPI(API_CANCEL_TIMING_TASK, params, "POST", 3000, this.secretKey, callback);
    ...
    this.setTags = function(tagsTokensMap, callback){
        ...
        //调用API
        callAPI(API_SET_TAGS, params, "POST", 3000, this.secretKey, callback);
    ...
    this.deleteTags = function(tagsTokensMap, callback){
        ...
        //调用API
        callAPI(API_DELETE_TAGS, params, "POST", 3000, this.secretKey, callback);
