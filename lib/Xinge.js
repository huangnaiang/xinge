...
function XingeApp(accessId, secretKey){
     ...
     * @param  {int}      environment           向iOS设备推送时必填，1表示推送生产环境；2表示推送开发环境。对Android平台无效
	 */
	this.pushToSingleDevice = function(deviceToken, message, callback, environment){
     ...
     * @param  {int}      environment           向iOS设备推送时必填，1表示推送生产环境；2表示推送开发环境。对Android平台无效
     */
	this.pushToSingleAccount = function(deviceType, account, message, callback, environment){
     ...
     * @param  {int}      environment           向iOS设备推送时必填，1表示推送生产环境；2表示推送开发环境。对Android平台无效
     */
	this.pushToAllDevices = function(deviceType, message, callback, environment){
     ...
     * @param  {int}      environment           向iOS设备推送时必填，1表示推送生产环境；2表示推送开发环境。对Android平台无效
     */
	this.pushByTags = function(deviceType, tags, tagOperation, message, callback, environment){
